...
<head>
    ...
    <style>
        ...
        .nav-item.active { color: #8b5cf6; } /* Purple highlight */
    </style>
</head>
<body class="pb-20"> <div class="top-bar sticky top-0 z-50 flex justify-between items-center p-4 shadow-md">
    <div class="flex items-center gap-2">
        <img src="assets/images/logo.png" alt="Logo" class="w-8 h-8 rounded-full bg-yellow-500" onerror="this.src='https://ui-avatars.com/api/?name=KF&background=eab308&color=fff'">
